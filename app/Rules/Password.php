    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('O :attribute deve ser pelo menos :length caracteres e conter ao menos um carac. maiúsculo.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __('O :attribute deve ter pelo menos :length caracteres e conter pelo menos um número.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireSpecialCharacter
                && ! $this->requireUppercase
                && ! $this->requireNumeric:
                return __('O : deve ter pelo menos :length caracteres e conter pelo menos um caractere especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('O :attribute deve ter pelo menos :length e conter pelo menos um caractere maiúsculo e um número.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireSpecialCharacter
                && ! $this->requireNumeric:
                return __('O :attribute deve ter pelo menos :length caractere e conter pelo menos um caractere maiúsculo e um caractere especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && $this->requireSpecialCharacter:
                return __('O :attribute deve ter pelo menos :length caractere e conter pelo menos um caractere maiúsculo, um número e um caractere especial..', [
                    'length' => $this->length,
                ]);

            default:
                return __('O :attribute deve ter pelo menos :length caracteres de comprimento.', [
                    'length' => $this->length,
                ]);
        }
    }
